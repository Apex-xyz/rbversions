...
local presets = {
	...
	Acid = {
		Colors = {
			OutsideStroke = Color3.fromRGB(17, 255, 53),
			MainBackground = Color3.fromRGB(17, 17, 17),
			BottomBar = Color3.fromRGB(57, 255, 80),
			TabBackground = Color3.fromRGB(26, 26, 26),
			TabImage_1 = Color3.fromRGB(47, 255, 89),
			TabImage_2 = Color3.fromRGB(122, 122, 122),
			TabTextColorOn = Color3.fromRGB(255, 255, 255),
			TabTextColorOff = Color3.fromRGB(200, 200, 200),
			TopBar = Color3.fromRGB(29, 29, 29),
			TabBar = Color3.fromRGB(20, 20, 20),
			GameName = Color3.fromRGB(152, 152, 152),
			ScriptName = Color3.fromRGB(47, 255, 89),
			SectionBackground = Color3.fromRGB(36, 36, 36),
			SectionText = Color3.fromRGB(59, 207, 57),
			ElementBackground = Color3.fromRGB(21, 21, 21),
			ElementText = Color3.fromRGB(255, 255, 255),
			SwitchEnabled = Color3.fromRGB(32, 255, 58),
			SwitchDisabled = Color3.fromRGB(38, 38, 38),
			TabEnabled = Color3.fromRGB(26, 26, 26),
			Glow = Color3.fromRGB(69, 255, 17),
			Tag = Color3.fromRGB(150, 150, 150),
			TabStick = Color3.fromRGB(32, 255, 58),
			TabNameBackgroundColor = Color3.fromRGB(36, 36, 36),
			TabNameTextColor = Color3.fromRGB(32, 255, 58),
			ButtonColor = Color3.fromRGB(32, 255, 58),
			ButtonColor2 = Color3.fromRGB(0, 255, 38),
			MouseColor = Color3.fromRGB(33, 255, 66),
			SliderInner = Color3.fromRGB(32, 255, 58),
			SliderBackground = Color3.fromRGB(30, 30, 30),
			SliderStroke = Color3.fromRGB(48, 48, 48),
			DropdownTextOff = Color3.fromRGB(22, 176, 40),
			DropdownTextOn = Color3.fromRGB(32, 255, 58),
			KeybindBackground = Color3.fromRGB(39, 39, 39)
		},
	}
}
local library = {
	...
	Component = {};
	Colors = {
		OutsideStroke = Color3.fromRGB(255, 37, 41),
		MainBackground = Color3.fromRGB(17, 17, 17),
		BottomBar = Color3.fromRGB(255, 48, 51),
		TabBackground = Color3.fromRGB(26, 26, 26),
		TabImage_1 = Color3.fromRGB(255, 37, 41),
		TabImage_2 = Color3.fromRGB(122, 122, 122),
		TabTextColorOn = Color3.fromRGB(255, 255, 255),
		TabTextColorOff = Color3.fromRGB(200, 200, 200),
		TopBar = Color3.fromRGB(29, 29, 29),
		TabBar = Color3.fromRGB(20, 20, 20),
		GameName = Color3.fromRGB(152, 152, 152),
		ScriptName = Color3.fromRGB(255, 37, 41),
		SectionBackground = Color3.fromRGB(36, 36, 36),
		SectionText = Color3.fromRGB(255, 37, 41),
		ElementBackground = Color3.fromRGB(21, 21, 21),
		ElementText = Color3.fromRGB(255, 255, 255),
		SwitchEnabled = Color3.fromRGB(255, 37, 41),
		SwitchDisabled = Color3.fromRGB(38, 38, 38),
		TabEnabled = Color3.fromRGB(26, 26, 26),
		Glow = Color3.fromRGB(255, 24, 28),
		Tag = Color3.fromRGB(150, 150, 150),
		TabStick = Color3.fromRGB(255, 37, 41),
		TabNameBackgroundColor = Color3.fromRGB(36, 36, 36),
		TabNameTextColor = Color3.fromRGB(32, 255, 58),
		ButtonColor = Color3.fromRGB(255, 37, 41),
		ButtonColor2 = Color3.fromRGB(255, 11, 15),
		MouseColor = Color3.fromRGB(255, 255, 255),
		SliderInner = Color3.fromRGB(255, 37, 41),
		SliderBackground = Color3.fromRGB(30, 30, 30),
		SliderStroke = Color3.fromRGB(48, 48, 48),
		DropdownTextOff = Color3.fromRGB(255, 37, 41),
		DropdownTextOn = Color3.fromRGB(255, 26, 30),
		KeybindBackground = Color3.fromRGB(39, 39, 39)
	},
...
function library.Component:AddTab(name, icon, __parent, __pagesinstance): Instance
	...
	local data = {Frame = NewTab, Content = NewPage, Used = First}
	...
	table.insert(library.Tabs, data)
	
	updatehsv.Event:Connect(function(h)
		if data.Used then
			NewTab.stick.BackgroundColor3 = Color3.fromHSV(h, 1, 0.8)
			NewTab.ImageLabel.ImageColor3 = Color3.fromHSV(h, 1, 0.8)
		end
		NewPage.ScrollingFrame.Frame.TextLabel.TextColor3 = Color3.fromHSV(h, 0.8, 1)
	end)
...
function library.Component:AddBase(name, __parent, desc, tt, ch)
	...
	updatehsv.Event:Connect(function(h)
		Base.UIStroke.Color = Color3.fromHSV(h, 0.87, 1)
	end)
	return Base
end
...
function library:AddWindow(windowproperties: table)
	updatehsv = Instance.new("BindableEvent")
	
	task.spawn(function()
		local hue = 0
		while task.wait() do
			hue = math.clamp(hue + (1 / 359), 0, 1)
			updatehsv:Fire(hue)
			if hue == 1 then
				hue = 0
			end
	...
	updatehsv.Event:Connect(function(h)
		MainFrame.UIStroke.Color = Color3.fromHSV(h, 1, 1)
		MainFrame.vshadow.ImageLabel.ImageColor3 = Color3.fromHSV(h, 1, 1)
		MainFrame.s.TextColor3 = Color3.fromHSV(h, 0.86, 0.8)
		MainFrame.btm.BackgroundColor3 = Color3.fromHSV(h, 1, 1)
	end)
	...
	function WindowData.AddTab(tabproperties)
		...
		function TabData.AddToggle(toggleproperties)
			...
			BindToClick(toggle.TextLabel2, function()
				...
				if not data.Enabled then
					toggle.TextLabel2.BackgroundColor3 = library.Colors['SwitchDisabled']
				end
			...
			updatehsv.Event:Connect(function(h)
				if data.Enabled then
					toggle.TextLabel2.BackgroundColor3 = Color3.fromHSV(h, 0.87, 1)
				end
			end)
		...
		function TabData.AddButton(buttonproperties)
			local button = library.Component:AddBase(buttonproperties.Name or 'Unknown', component.Content.ScrollingFrame, buttonproperties.Description, buttonproperties.ToolTip, {
				Create("TextLabel", {
					...
					TextSize = 12,
					Text = buttonproperties.ButtonText or "Button",
					TextColor3 = Color3.fromRGB(255, 255, 255),
			...
			updatehsv.Event:Connect(function(h)
				button.TextLabel2.TextColor3 = Color3.fromHSV(h, 0.87, 1)
				button.TextLabel2.UIStroke.Color = Color3.fromHSV(h, 0.87, 1)
			end)
		end
		function TabData.AddSlider(sliderproperties)
			...
			updatehsv.Event:Connect(function(h)
				slider.Inner.Inner.BackgroundColor3 = Color3.fromHSV(h, 0.87, 1)
			end)
			...
			local function refresh()
				...
				for e, f in ipairs(dropdownproperties.Array or {}) do
					...
					table.insert(dconnections, newobject.MouseEnter:Connect(function()
						...
						newobject.TextLabel.TextColor3 = Color3.fromRGB(123, 123, 123)
					end))
					...
					local function updated()
						...
						newobject.TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
		...
		function TabData.AddKeybind(bindproperties)
			...
			local chaningk = false

			keybindconnection = InputService.InputBegan:Connect(function(input, gpe)
				if gpe then return end
				if data.Bind ~= nil and input.KeyCode == Enum.KeyCode[data.Bind] and not chaningk then
			...
			BindToClick(keybind.TextLabel, function()
				...
				if newkey.KeyCode ~= Enum.KeyCode.Unknown then
					if newkey.KeyCode.Name == keybind.TextLabel2.TextLabel.Text then
						keybind.TextLabel2.ImageLabel.Visible = true
						keybind.TextLabel2.TextLabel.Text = ""
						data.Bind = nil
						return
					end
			...
			updatehsv.Event:Connect(function(h)
				keybind.TextLabel2.TextLabel.TextColor3 = Color3.fromHSV(h, 0.87, 1)
				keybind.TextLabel2.ImageLabel.ImageColor3 = Color3.fromHSV(h, 0.87, 1)
			end)
		...
		function TabData.AddTextBox(boxproperties)
			...
			updatehsv.Event:Connect(function(h)
				box.Box.Input.TextColor3 = Color3.fromHSV(h, 0.87, 1)
			end)
		...
		function TabData:Divide(x)
			...
			updatehsv.Event:Connect(function(h)
				division.TextLabel.TextColor3 = Color3.fromHSV(h, 0.87, 1)
			end)
		end
		return TabData
	end
